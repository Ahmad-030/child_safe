...
import '../face_verification_service.dart'; // FIX: import FaceVerificationResult
  ...
  void _startMarkAsFoundFlow() {
    ...
    showModalBottomSheet(
      ...
      builder: (_) => FaceVerificationSheet(
        ...
        // FIX: updated callback to accept both File and FaceVerificationResult
        onVerified: (File photo, FaceVerificationResult result) async {
          if (!mounted) return;
