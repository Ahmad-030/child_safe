...
/// 2. Sends both images to Google Gemini for exact face comparison.
/// 3. Calls [onVerified] with the taken photo file + result when done.
...
class FaceVerificationSheet extends StatefulWidget {
  ...
  final void Function(File photo, FaceVerificationResult result) onVerified;
  ...
  static Future<void> show(
      BuildContext context, {
        ...
        required void Function(File photo, FaceVerificationResult result) onVerified,
...
class _FaceVerificationSheetState extends State<FaceVerificationSheet> {
  ...
  Future<void> _runVerification() async {
    ...
    try {
      ...
      if (widget.originalPhotoUrl == null ||
        ...
        // No reference photo on file — skip verification.
  ...
  void _proceed() {
    ...
    widget.onVerified(_capturedPhoto!, _result!);
  }
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Face API · Confirm this is ${widget.childName}',
                        style: GoogleFonts.poppins(
      ...
      children: [
        ...
        if (originalPhotoUrl != null && originalPhotoUrl!.isNotEmpty) ...[
          Align(
            ...
            child: Text('Reference photo of $childName:',
                style: GoogleFonts.poppins(
                    fontSize: 13,
        ...
        Container(
          ...
          child: Row(children: [
            ...
            Expanded(
              child: Text(
                'Face API will compare both photos for an exact face match. Ensure the face is well-lit and clearly visible.',
                style: GoogleFonts.poppins(
      ...
      children: [
        ...
        Center(
          child: ClipRRect(
            ...
            child:
            Image.file(photo, height: 200, width: 200, fit: BoxFit.cover),
          ),
        ),
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 20),
        Text('Sending to Face API...',
            style: GoogleFonts.poppins(
                fontSize: 15,
                fontWeight: FontWeight.w600,
                color: AppTheme.textDark)),
        const SizedBox(height: 8),
        Text('Comparing facial features with vision model',
            style:
      ...
      children: [
        ...
        Container(
          ...
          child: Column(children: [
            ...
            // Confidence badge
            const SizedBox(height: 10),
            _ConfidenceBadge(level: result.confidence),

            // Similarity bar (only when Gemini returned a score)
            if (result.similarity > 0) ...[
              const SizedBox(height: 12),
              _SimilarityBar(
                  similarity: result.similarity, color: statusColor),
              const SizedBox(height: 6),
        ...
        Center(
          child: ClipRRect(
            borderRadius: BorderRadius.circular(12),
            child:
            Image.file(photo, height: 80, width: 80, fit: BoxFit.cover),
          ),
        ),
        const SizedBox(height: 20),
        ...
        if (result.isMatch) ...[
          ...
          // No match — warn before allowing override.
          Container(
            ...
            child: Row(children: [
              ...
              Expanded(
                child: Text(
                  'Face API determined this is likely NOT the same child. Verify carefully before proceeding.',
                  style: GoogleFonts.poppins(
